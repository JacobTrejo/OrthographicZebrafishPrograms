...
directory2 = 'Chie_test_dataset_constant_fish_100k/resnet_labels/train_compressed_4/'
directory1 = 'Chie_test_dataset_constant_fish_100k/images/train/'
...
for file in unique_files_dir1:
    print(file)
    os.remove(f'{directory1}{file}.png')
    print('Deleted file')
