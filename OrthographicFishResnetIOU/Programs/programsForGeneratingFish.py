...
def get_good_dtheta_indices_chuncks(x,y,theta0,seglen, overlappingFishVectList, fishVectToOverlapp,chunk):
    ...
    """
    pts = angles_array_to_keypoints(theta_array[50000 * chunk :50000 * (chunk + 1),...], [x,y,theta0], seglen)
...
def generateRandomConfiguration_2D(fishInView, fishInEdges, OverlappingFish):
    averageSizeOfFish = Config.averageSizeOfFish
    fishVectList = []
