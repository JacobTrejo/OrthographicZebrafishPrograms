...
class ResNetEncoder(nn.Module):
    ...
    """
    def __init__(self, in_channels=3, blocks_sizes=[32, 64, 128, 256, 512, 1024], deepths=[2,2,2], 
...
def resnet18(in_channels, n_classes, block=ResNetBasicBlock, *args, **kwargs):
    return ResNet(in_channels, n_classes, block=block, deepths=[2, 2, 2, 2, 2, 2], *args, **kwargs)
