...
def parse_command_line():
    ...
    parser.add_argument('-c', '--continue_exp', default = 'test_run_8HG_4_less_that_25_att',type=str, help='continue exp')
    ...
    parser.add_argument('-f', '--place_holder', type=str, default='whatever', help='whateverV2')
